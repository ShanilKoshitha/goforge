...
const (
	...
	goForgeGeneratedMarker   = "// Code generated by GoForge. DO NOT EDIT."
)
...
func hasGoForgeGeneratedMarker(contents []byte) bool {
	line, _, _ := bytes.Cut(contents, []byte("\n"))
	line = bytes.TrimSuffix(line, []byte("\r"))
	return bytes.Equal(line, []byte(goForgeGeneratedMarker))
}
