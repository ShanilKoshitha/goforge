...
func TestRunNewCreatesInspectableApplication(t *testing.T) {
	...
	if !strings.Contains(string(moduleFile), "github.com/ShanilKoshitha/goforge v0.9.0") {
		t.Fatalf("scaffold does not pin GoForge v0.9.0:\n%s", moduleFile)
	}
