...
func TestNewRejectsUnsafeAndAmbiguousInventory(t *testing.T) {
	tests := []struct {
		...
		{name: "trailing dot", files: fstest.MapFS{"files/theme./app.css": &fstest.MapFile{Data: []byte("x")}}},
		{name: "windows reserved name", files: fstest.MapFS{"files/CON.css": &fstest.MapFile{Data: []byte("x")}}},
		{name: "windows reserved directory", files: fstest.MapFS{"files/com1/app.css": &fstest.MapFile{Data: []byte("x")}}},
